...
docstyle-check:  # Check geoopt_layers with pydocstyle
	@printf "Checking documentation with pydocstyle...\n"
	pydocstyle geoopt_layers
	@printf "\033[1;34mPydocstyle passes!\033[0m\n\n"

codestyle-check:  # Check geoopt_layers with black
	@printf "Checking code style with black...\n"
	black --check --diff geoopt_layers tests
	@printf "\033[1;34mBlack passes!\033[0m\n\n"

linter-check:  # Check geoopt_layers with pylint
	@printf "Checking code style with pylint...\n"
	pylint geoopt_layers
	@printf "\033[1;34mPylint passes!\033[0m\n\n"

black:  # Format code in-place using black.
	black geoopt_layers tests

test:  # Test code using pytest.
	pytest -v geoopt_layers tests --doctest-modules --html=testing-report.html --self-contained-html
